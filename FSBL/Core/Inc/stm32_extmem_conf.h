...
#define EXTMEM_LRUN_DESTINATION_ADDRESS_NS 0x24100000u
#define EXTMEM_LRUN_SOURCE_ADDRESS_NS 0x00200000u

/* USER CODE BEGIN EC */
#define EXTMEM_MACRO_DEBUG(__MSG__) extMemDebug(__MSG__)
...
/* USER CODE BEGIN PFP */
#ifdef EXTMEM_MACRO_DEBUG
void extMemDebug(const char* msg);
#endif
/* USER CODE END PFP */
